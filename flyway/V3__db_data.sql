...
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Alice', 'Smith', 'alicesmith456', '1985-08-23', lms.crypt('alicesmith4561985', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Michael', 'Johnson', 'mikejohnson789', '1992-02-10', lms.crypt('mikejohnson7891992', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Emma', 'Williams', 'emmaw123', '1988-11-30', lms.crypt('emmaw1231988', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('William', 'Brown', 'will.brown', '1995-04-18', lms.crypt('will.brown1995', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Ethan', 'Davis', 'ethand', '1987-09-12', lms.crypt('ethand1987', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Olivia', 'Lee', 'olivialee', '1993-03-25', lms.crypt('olivialee1993', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Liam', 'Anderson', 'liamand', '1986-06-20', lms.crypt('liamand1986', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Ava', 'Clark', 'avaclark', '1994-01-08', lms.crypt('avaclark1994', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Mason', 'Walker', 'masonw', '1989-12-02', lms.crypt('masonw1989', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Harper', 'Evans', 'harper123', '1996-08-14', lms.crypt('harper1231996', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Logan', 'Turner', 'logant', '1984-10-05', lms.crypt('logant1984', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Ella', 'Baker', 'ellab', '1997-06-28', lms.crypt('ellab1997', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Carter', 'Perez', 'carterp', '1983-09-03', lms.crypt('carterp1983', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Grace', 'Ward', 'graceward', '1998-11-17', lms.crypt('graceward1998', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Lucas', 'Hayes', 'lucash', '1982-12-09', lms.crypt('lucash1982', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Lily', 'Fisher', 'lilyf', '1999-04-11', lms.crypt('lilyf1999', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Landon', 'Ramirez', 'landonr', '1981-02-01', lms.crypt('landonr1981', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Chloe', 'Barnes', 'chloeb', '2000-07-22', lms.crypt('chloeb2000', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Alexander', 'Gonzalez', 'alexg', '1980-03-19', lms.crypt('alexg1980', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Aria', 'Cooper', 'ariac', '2001-10-13', lms.crypt('ariac2001', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Daniel', 'Gray', 'danielg', '1979-05-07', lms.crypt('danielg1979', lms.gen_salt('bf', 6)), 3);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Jackson', 'Parker', 'jacksonp', '1978-01-16', lms.crypt('jacksonp1978', lms.gen_salt('bf', 6)), 2);
INSERT INTO lms.user (first_name, last_name, username, date_of_birth, password_hash, role_id) VALUES ('Mia', 'Lopez', 'mial', '2003-12-05', lms.crypt('mial2003', lms.gen_salt('bf', 6)), 3);
...
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('gamer_girl42@example.org', '444-234-5678', 2);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coding_ninja_01@example.net', '333-345-6789', 3);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('bookworm_88@example.com', '222-456-7890', 4);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('music_lover99@example.org', '111-567-8901', 5);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('traveler_007@example.net', '666-678-9012', 6);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('foodie_22@example.com', '777-789-0123', 7);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('fitness_guru_123@example.org', '888-890-1234', 8);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('tech_geek@example.net', '999-901-2345', 9);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coffee_addict@example.com', '123-012-3456', 10);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('adventure_seeker@example.org', '234-123-4567', 11);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('daydreamer_42@example.net', '345-234-5678', 12);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('night_owl@example.com', '456-345-6789', 13);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES (null, '567-456-7890', 14);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('globe_trotter@example.net', '678-567-8901', 15);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('hiking_enthusiast@example.com', '789-678-9012', 16);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coding_guru@example.org', '890-789-0123', 17);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coffee_lover_22@example.net', '901-890-1234', 18);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('star_gazer@example.com', '012-901-2345', 19);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('travel_bug_88@example.org', '123-112-3456', 20);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coding_whiz@example.net', '234-223-4567', 21);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('food_explorer@example.com', '345-334-5678', 22);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('yoga_master@example.org', '456-445-6789', 23);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('skydiver_007@example.net', '567-556-7890', 24);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('art_lover_123@example.com', '678-667-8901', 25);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('movie_buff@example.org', '789-778-9012', 26);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('gaming_enthusiast@example.net', '890-889-0123', 27);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES (null, '901-900-1234', 28);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('fitness_freak@example.org', '012-011-2345', 29);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('nature_lover_22@example.net', '123-122-3456', 30);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('photography_lover@example.com', '234-233-4567', 31);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES (null, '345-344-5678', 32);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('dreamer_42@example.net', '456-455-6789', 33);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('adventure_seeker_007@example.com', '567-566-7890', 34);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coding_nerd_123@example.org', '678-677-8901', 35);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('travel_enthusiast@example.com', '111-111-2222', 36);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coding_mastermind@example.org', '222-222-3333', 37);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('gourmet_cook@example.net', '333-333-4444', 38);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES (null, '444-444-5555', 39);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('music_maestro@example.org', '555-555-6666', 40);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('book_lover@example.net', '666-666-7777', 41);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('nature_observer@example.com', '777-777-8888', 42);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coding_whizkid@example.org', '888-888-9999', 43);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('adventure_seeker_22@example.net', '999-999-0000', 44);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coffee_addict_22@example.com', '000-000-1111', 45);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES (null, '111-111-2222', 46);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('music_lover_22@example.net', '222-222-3333', 47);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('bookworm_22@example.com', '333-333-4444', 48);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('coding_pro_22@example.org', '444-444-5555', 49);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('traveler_22@example.net', '555-555-6666', 50);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES ('art_enthusiast_22@example.com', '666-666-7777', 51);
INSERT INTO lms.user_contact (email, phone_number, user_id) VALUES (null, '777-777-8888', 52);
