...
public class DataSourceConfig {
    ...
    private static void initializeDataSource(InputStream inputStream) throws IOException {
        ...
        config.addDataSourceProperty("ssl", properties.getProperty("datasource.ssl"));
        config.addDataSourceProperty("sslmode", properties.getProperty("datasource.sslmode"));
        config.addDataSourceProperty("sslcert", properties.getProperty("datasource.sslcert"));
        config.addDataSourceProperty("sslkey", properties.getProperty("datasource.sslkey"));
        config.addDataSourceProperty("sslrootcert", properties.getProperty("datasource.sslrootcert"));
