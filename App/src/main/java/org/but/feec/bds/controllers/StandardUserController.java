...
public class StandardUserController {
    ...
    @FXML
    public void searchActionHandler(ActionEvent event) {
        handleSearch();
    }

    private void handleSearch() {
        ObservableList<BookSimpleView> observableBookSimpleViews = FXCollections.observableArrayList(bookService.getBooksSimpleViewByTitleSimilarity(searchTextField.getText()));
        booksTableView.setItems(observableBookSimpleViews);
        librariesTableView.getSortOrder().add(libraryIdColumn);
    }
