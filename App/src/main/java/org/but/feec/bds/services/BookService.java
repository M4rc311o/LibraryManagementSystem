...
public class BookService {
    ...
    public List<BookSimpleView> getBooksSimpleViewByTitleSimilarity(String titleSimilarity) {
        return bookRepository.getBooksSimpleViewByTitleSimilarity(titleSimilarity);
    }
